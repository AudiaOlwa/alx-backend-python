...
if connection:
    ...
    if connection:
        ...
        cursor.execute(f"SELECT SCHEMA_NAME FROM INFORMATION_SCHEMA.SCHEMATA WHERE SCHEMA_NAME = 'alx_travel_app';")
        result = cursor.fetchone()
        if result:
            print(f"Database alx_travel_app is present ")
...
Database alx_travel_app is present 
